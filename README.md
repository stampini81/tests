...
[![Test Validation](https://github.com/stampini81/tests/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/stampini81/tests/actions/workflows/tests.yml)
